...
import { WireType, FieldTypeToWireType, FieldType, INVALID_FIELD_NUMBER, } from "./constants.js";
...
export class BinaryReader {
    ...
    nextField() {
        ...
        if (nextWireType != WireType.VARINT &&
            ...
            fail(`Invalid wire type: ${nextWireType} (at position ${this.fieldCursor_})`);
            this.error_ = true;
            return false;
        }
     ...
     */
    registerReadCallback(callbackName, 
    ...
    getFieldDecoder() {
        ...
        const innerDecoder = BinaryDecoder.alloc(this.decoder_.getBuffer(), start, length);
