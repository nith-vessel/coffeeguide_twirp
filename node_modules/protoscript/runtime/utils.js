...
import { FLOAT32_MAX, FLOAT32_MIN, FLOAT64_MAX, FLOAT64_MIN, TWO_TO_20, TWO_TO_23, TWO_TO_32, TWO_TO_52, } from "./constants.js";
/**
 ...
 *
 */
export function fromZigzag64(bitsLow, bitsHigh, 
 ...
 */
export function toZigzag64(bitsLow, bitsHigh, 
// eslint-disable-next-line no-unused-vars
convert) {
    // See
 ...
 */
export const splitInt64 = function (value) {
 ...
 */
export const splitUint64 = function (value) {
    // Extract low 32 bits and high 32 bits as unsigned integers.
 ...
 */
export const splitZigzag64 = function (value) {
 ...
 * in the temp values above.
 */
export const splitHash64 = function (hash) {
 ...
 */
export const splitFloat32 = function (value) {
 ...
 * it in the temp values above.
 */
export const splitFloat64 = function (value) {
    const sign = value < 0 ? 1 : 0;
    value = sign ? -value : value;
    // Handle zeros.
    if (value === 0) {
 ...
 */
export const joinUint64 = function (bitsLow, bitsHigh) {
 ...
 */
export const joinInt64 = function (bitsLow, bitsHigh) {
 ...
 */
export function joinFloat32(bitsLow) {
 ...
 * converts it back into a Javascript number.
 */
export const joinFloat64 = function (bitsLow, bitsHigh) {
 ...
 */
export const joinUnsignedDecimalString = function (bitsLow, bitsHigh) {
    ...
    return (decimalFrom1e7(digitC, 0) +
 ...
 * into a decimal string.
 */
export const joinSignedDecimalString = function (bitsLow, bitsHigh) {
