...
export declare const FieldMask: {
     ...
     * @private
     */
    _readMessage: (msg: FieldMask, reader: BinaryReader) => FieldMask;
};
export declare const FieldMaskJSON: {
    /**
     ...
     * @private
     */
    _readMessage: (msg: FieldMask, json: any) => FieldMask;
};
