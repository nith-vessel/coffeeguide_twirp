...
export declare const Timestamp: {
     ...
     */
    decode: (bytes: ByteSource) => Timestamp;
    /**
     ...
     * @private
     */
    _readMessage: (msg: Timestamp, reader: BinaryReader) => Timestamp;
};
export declare const TimestampJSON: {
    /**
     ...
     * @private
     */
    _readMessage: (msg: Timestamp, json: any) => Timestamp;
};
